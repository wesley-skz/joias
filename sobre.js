document.addEventListener('DOMContentLoaded', function() {
    // Verifica se o formulário de contato existe nesta página
    const form = document.getElementById('contactForm');
    if (!form) {
        return; // Sai se não estiver na página de contato
    }
    ...
    // Função para simular o envio (substitua por uma chamada AJAX real em produção)
